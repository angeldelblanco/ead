 ...
 *
 * There are not setter method for {@link Dialog#maximizable} does not appear in order to avoid
 * methods with non-typical behaviours: the maximizer button is added at the
 * dialog creation and the {@link Dialog#maximizable} only inform about if that button was included or not
 * 
 * 
 */
